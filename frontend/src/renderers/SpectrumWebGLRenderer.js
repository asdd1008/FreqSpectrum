export class SpectrumWebGLRenderer {
  ...
  drawMaxHold() {
    ...
    gl.uniform1f(plotWidthLocation, this.plotArea.width)
    gl.uniform1f(plotHeightLocation, this.plotArea.height)
    gl.uniform4f(colorLocation, 1.0, 0.42, 0.42, 1.0)
  ...
  drawMinHold() {
    ...
    gl.uniform1f(plotWidthLocation, this.plotArea.width)
    gl.uniform1f(plotHeightLocation, this.plotArea.height)
    gl.uniform4f(colorLocation, 0.31, 0.80, 0.77, 1.0)
  ...
  drawAvg() {
    ...
    gl.uniform1f(plotWidthLocation, this.plotArea.width)
    gl.uniform1f(plotHeightLocation, this.plotArea.height)
    gl.uniform4f(colorLocation, 1.0, 0.85, 0.23, 1.0)
  ...
  drawLegend() {
    ...
    this.drawWaterfallColorBar(ctx)
    
    ctx.restore()
  }

  drawWaterfallColorBar(ctx) {
    const barWidth = 15
  ...
  draw2DOverlay(ctx) {
    ...
    this.drawHighlightedSignals(ctx)
    this.drawMarkers(ctx)
    this.drawLevelIndicator(ctx)
    this.drawBoxSelection(ctx)
    this.drawRightBoxSelection(ctx)
    this.drawTimeLine(ctx)
    
    ctx.restore()
  }

  drawHighlightedSignals(ctx) {
